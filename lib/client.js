...
`,
          ...
          <g class="body">
            ...
            <!-- 顶发：外轮廓略宽于头（有体积），两侧自然垂到颧骨 -->
            <path d="M13 1.4 C9.0 1.4 6.8 4.3 6.8 8.4 C6.8 9.7 7.0 10.8 7.4 11.6 L7.5 8.5 C7.5 5.7 9.7 4.0 13 4.0 C16.3 4.0 18.5 5.7 18.5 8.5 L18.6 11.6 C19.0 10.8 19.2 9.7 19.2 8.4 C19.2 4.3 17.0 1.4 13 1.4 Z" fill="url(#lingHair)"/>
            <!-- 刘海：两束从中分向两侧扫下，发梢在颧骨处外翻（不再是锅盖边） -->
            <path d="M13 3.3 C10.7 3.4 8.9 4.6 8.0 6.4 C7.8 7.0 7.9 7.7 8.2 8.2 C8.6 7.0 9.3 6.0 10.3 5.4 C11.2 6.6 12.0 7.1 13 7.1 C14.0 7.1 14.8 6.6 15.7 5.4 C16.7 6.0 17.4 7.0 17.8 8.2 C18.1 7.7 18.2 7.0 18.0 6.4 C17.1 4.6 15.3 3.4 13 3.3 Z" fill="url(#lingHair)"/>
            <!-- 发丝高光（顶上不再是一块死黑） -->
            <path d="M9.8 4.8 C11.2 4.0 14.8 4.0 16.2 4.8" fill="none" stroke="#6E6680" stroke-width="0.2" stroke-linecap="round" opacity=".55"/>
            <path d="M13 2.6 L13 5.7" fill="none" stroke="#5A5266" stroke-width="0.14" stroke-linecap="round" opacity=".7"/>
            <!-- 双丫髻：小发环 + 蓝发绳 + 垂下的蓝丝带 -->
