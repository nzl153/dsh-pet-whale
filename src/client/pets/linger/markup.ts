...
export const LINGER_HTML = `<svg viewBox="0 0 26 48" aria-hidden="true">
          ...
          <g class="body">
            ...
            <!-- 刘海：两束从中分向两侧扫下 -->
            <path d="M13 4.6 C10.9 4.7 9.2 5.9 8.4 7.6 C8.2 8.2 8.3 8.8 8.6 9.3 C8.9 8.1 9.6 7.1 10.5 6.5 C11.3 7.6 12.1 8.0 13 8.0 C13.9 8.0 14.7 7.6 15.5 6.5 C16.4 7.1 17.1 8.1 17.4 9.3 C17.7 8.8 17.8 8.2 17.6 7.6 C16.8 5.9 15.1 4.7 13 4.6 Z" fill="url(#lingHair)"/>
            <!-- 中分线（头顶中间是分缝，不堆头发） -->
            <path d="M13 3.2 L13 5.2" fill="none" stroke="#6E6680" stroke-width="0.16" stroke-linecap="round" opacity=".8"/>
            <path d="M11.5 3.5 C12.2 3.2 13.8 3.2 14.5 3.5" fill="none" stroke="#6E6680" stroke-width="0.14" stroke-linecap="round" opacity=".45"/>
